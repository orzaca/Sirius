...
<body>
    ...
    <div class="content-wrapper">
        ...
        foreach ($paragraphs as $para) {
            ...
            echo '<button onclick="copyText(\'para4' . $para['id'] . '\')">Copiar</button>';// Cambiado a para2
            echo '<button onclick="openEditModal4(' . $para['id'] . ')">Modificar</button>';
    ...
    <div id="editModal3"> <!-- Cambiado a editModal3 -->
        <div class="modal-content">
            <span class="close-btn" onclick="closeEditModal()">&times;</span>
            <h2>Editar Párrafo</h2>
            <textarea id="editText3" rows="4" style="width: 100%;"></textarea> <!-- Cambiado a editText3 -->
            <button id="saveChanges3" onclick="saveParagraph()">Guardar</button> <!-- Cambiado a saveChanges3  -->
        </div>
    </div>
